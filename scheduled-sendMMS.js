...
let qry1 = `SELECT app_name, status, last_run_date FROM scheduler WHERE app_name = 'app02'`;
let qry0 = `SELECT app_name, status, last_run_date FROM scheduler WHERE app_name = 'app01'`;
